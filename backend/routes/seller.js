...
import { allSellers, approveSeller, deleteSeller, getSellerDetails, registerSeller } from "../controllers/seller.js";
...
router.route('/admin/sellers/:id/approve').put(isAuthenticatedUser, authorizeRoles("admin"), approveSeller);
